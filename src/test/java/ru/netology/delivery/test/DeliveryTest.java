...
public class DeliveryTest {
    ...
    public String delete() {
        return Keys.chord(Keys.COMMAND, "a") + Keys.BACK_SPACE;
    }
    ...
    void shouldBeReservedMeet() {
        ...
        $("[data-test-id='success-notification'] .notification__content").shouldBe(Condition.text(DataGenerator.generateDate(daysToAddForFirstMeeting)));
    }
}
